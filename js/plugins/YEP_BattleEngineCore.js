...
Yanfly.Param.BECHelpUserTx = String('Применить на себя');
Yanfly.Param.BECHelpAllyTx = String('Применить на союзника');
Yanfly.Param.BECHelpAlliesTx = String('Применить на союзников');
Yanfly.Param.BECHelpEnemyTx = String('Применить на врагов');
Yanfly.Param.BECHelpEnemiesTx = String('Все враги');
Yanfly.Param.BECHelpAllTx = String('Все');
Yanfly.Param.BECHelpRandTx = String('Случайный противник ');
