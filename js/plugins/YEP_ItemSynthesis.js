...
Yanfly.Param.ISItemCmd = String('Создать предмет');
Yanfly.Param.ISWeaponCmd  = String('Создать оружие');
Yanfly.Param.ISArmorCmd  = String('Создать броню');
Yanfly.Param.ISFinishCmd = String('Выйти');
Yanfly.Param.ISTextAlign = String(Yanfly.Parameters['Text Alignment']);

Yanfly.Param.ISColRecipes = String('Найденные рецепты');
Yanfly.Param.ISCraftedItems = String('Созданные предметы');
Yanfly.Param.ISCraftedWeapons = String('Созданное оружие');
Yanfly.Param.ISCraftedArmors = String('Созданная броня');
...
Yanfly.Param.ISMaskHelpText = String('Этот предмет еще не создавался.');
Yanfly.Param.ISIngredientsList = String('Ингредиенты');
Yanfly.Param.ISAmountText = String('Количество');
